...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'字典', 'url'=>array('/swordfish/extDict'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'停止词', 'url'=>array('/swordfish/stopWord'), 'visible'=>!Yii::app()->user->isGuest),
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by 电商比价搜索.<br/>
